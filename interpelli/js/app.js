...
function pr() {
  ...
  newContent += '<a title="Apertura in nuova scheda" href="' + textUrl.trim() + url.trim() + '" target="_blank" rel="noopener" aria-label="' + title + ' (PDF, ' + size.trim() + ') - Apertura in nuova scheda">' + title.trim() + '</a>';
  newContent += '<br />';
